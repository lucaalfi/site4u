        ...
        <div className={styles.contactHolder}>
            <div className={styles.contactContents}>
                <div className={styles.contactCard}>
                    ...
                    <div className={styles.contactBubble}><h4>Call us at: (1)-647-794-8811</h4></div>
                    <div className={styles.contactBubble}><h4>OR</h4></div>
                    <div className={styles.contactBubble}><h4>Email us at: contact@site4u.ca</h4></div>
